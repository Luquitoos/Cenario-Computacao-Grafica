...
inline std::shared_ptr<transform> translate_object(
    std::shared_ptr<hittable> obj, double tx, double ty, double tz) {
...
inline std::shared_ptr<transform> rotate_x_object(
    std::shared_ptr<hittable> obj, double angle_rad) {
...
inline std::shared_ptr<transform> rotate_y_object(
    std::shared_ptr<hittable> obj, double angle_rad) {
...
inline std::shared_ptr<transform> rotate_z_object(
    std::shared_ptr<hittable> obj, double angle_rad) {
...
inline std::shared_ptr<transform> rotate_axis_object(
    std::shared_ptr<hittable> obj, const vec3& axis, double angle_rad) {
...
inline std::shared_ptr<transform> scale_object(
    std::shared_ptr<hittable> obj, double sx, double sy, double sz) {
...
inline std::shared_ptr<transform> shear_object(
...
inline std::shared_ptr<transform> reflect_object(
    std::shared_ptr<hittable> obj, const vec3& plane_point, const vec3& plane_normal) {
...
inline std::shared_ptr<transform> compose_transform(
    std::shared_ptr<hittable> obj,
    ...
    mat4 Sinv = mat4::scale_inverse(scale_factors.x(), scale_factors.y(), scale_factors.z());
    mat4 Rinv = rotate_axis_inverse(rotation_axis, rotation_angle);
    mat4 Tinv = mat4::translate_inverse(translation.x(), translation.y(), translation.z());

...
public:
    ...
    point_light(const point3& pos, const color& i, 
                double att_c1 = 1.0, double att_c2 = 0.0, double att_c3 = 0.0)
...
public:
    ...
    spot_light() : position(0, 0, 0), direction(0, -1, 0),
                   inner_angle(0.3), outer_angle(0.5),
                   c1(1), c2(0), c3(0) {}

    spot_light(const point3& pos, const vec3& dir, const color& i,
               double inner_ang, double outer_ang,
               double att_c1 = 1.0, double att_c2 = 0.0, double att_c3 = 0.0)
        : light(i), position(pos), direction(unit_vector(dir)),
          inner_angle(inner_ang), outer_angle(outer_ang),
          c1(att_c1), c2(att_c2), c3(att_c3) {}

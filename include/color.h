...
public:
    ...
    int r_byte() const { return static_cast<int>(255.999 * std::max(0.0, std::min(1.0, r))); }
    int g_byte() const { return static_cast<int>(255.999 * std::max(0.0, std::min(1.0, g))); }
    int b_byte() const { return static_cast<int>(255.999 * std::max(0.0, std::min(1.0, b))); }
};

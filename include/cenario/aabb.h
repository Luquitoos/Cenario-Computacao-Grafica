...
// Axis-Aligned Bounding Box para aceleração de ray tracing
class aabb {
public:
  point3 minimum;
  point3 maximum;
  ...
  // Teste de interseção ray-box otimizado (algoritmo slab)
  ...
  // Cria uma bounding box que engloba duas outras
